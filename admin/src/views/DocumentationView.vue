...
import DocComponent from '@/components/DocComponent.vue';
  ...
  },
  {
    ...
    exampleRequest: 'GET /api/pairs',
    exampleResponse: '{"pairs":\n[{"from":"GBP","to":"EUR","conversion_rate":"0.4000"},\n{"from":"GBP","to":"USD","conversion_rate":"0.3000"}\n]}'
  },
  {
    route: '/api/convert',
    ...
    exampleRequest: 'GET /api/convert?from=USD&to=EUR&amount=100',
